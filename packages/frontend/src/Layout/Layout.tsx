...
export const Layout = ({ children, displayMenu = true }: Props) => (
  <div className="min-h-screen flex flex-col justify-center items-center bg-gray-100 py-4">
    <div className="flex items-center mb-12">
      <Icon />
      <h1 className="text-4xl font-bold text-center text-gray-800">
        <span className="text-palette-secondary">Rug</span>
        <span className="text-palette-primary">Be</span>
        <span className="text-palette-secondary">Wise</span>
      </h1>
    </div>
    {children}
    {displayMenu && <Menu />}
